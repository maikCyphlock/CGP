...
CREATE TABLE person_type (
    id          SMALLSERIAL PRIMARY KEY,
    code        VARCHAR(20) NOT NULL UNIQUE, -- 'CITIZEN', 'STAFF'
...
CREATE TABLE person (
    ...
    person_type_id  SMALLINT NOT NULL REFERENCES person_type(id),
    ...
    -- Atributos dinámicos en JSONB (Filosofía de tu esquema)
